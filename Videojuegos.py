...
# ── Clase Servicio ───────────────────────────────────────────────────────────
# Garantía, precio base, tipo de servicio, valor de reparación, tiempo de entrega.
# Métodos: mostrar_info(), calcular_precio_final()
class Servicio():
...
class Carrito:
    def __init__(self): #Constructor: lista de productos vacía
        self.productos = []
    ...
    def quitar_producto(self, indice): #Metodo para quitar un producto del carrito
    ...
    def total(self): #Metodo para calcular el total del carrito
        return sum(producto.precio for producto in self.productos)

    def esta_vacio(self): #Metodo para verificar si el carrito está vacío
        return len(self.productos) == 0

    def mostrar_info(self): #Metodo para mostrar la información del carrito
        if self.esta_vacio():
    ...
    def vaciar(self): #Metodo para vaciar el carrito
        self.productos.clear()


# ── Clase Videojuego ─────────────────────────────────────────────────────────
# Extiende de Producto: título, género, precio, plataforma
class Videojuego(Producto):
    ...
    def calcular_precio_final(self): #Metodo para calcular precio final del videojuego
        return self._precio
...
class Usuario():
    ...
    def agregar_al_carrito(self, producto): #Metodo para agregar un producto al carrito del usuario
        self.carrito.agregar_producto(producto)

    def quitar_del_carrito(self, indice): #Metodo para quitar un producto del carrito del usuario
        self.carrito.quitar_producto(indice)

    def pagar_carrito(self): #Metodo para pagar el carrito y procesar la compra
    ...
    def comprar_juego(self, videojuego): #Metodo para comprar un videojuego directamente (método legado)
...
class VideojuegoDigital(Videojuego):
    ...
    def mostrar_info(self): #Metodo para mostrar información del videojuego digital con descuento
...
class Accesorio(Producto):
    ...
    def get_precio(self): #Metodo para obtener precio del accesorio
...
def main():#Función principal con menú para la tienda de videojuegos
    ...
    while True:
        ...
        elif opcion == "3": #Opción 3: Agregar producto al carrito
        ...
        elif opcion == "4": #Opción 4: Ver contenido del carrito de un usuario
            print("\n--- VER CARRITO ---")
            for i, usuario in enumerate(usuarios, 1): 
                print(f"{i}. {usuario.nombre} (Saldo: ${usuario.get_saldo():.2f})")
        ...
        elif opcion == "5": #Opción 5: Pagar el carrito
            print("\n--- PAGAR CARRITO ---")
            for i, usuario in enumerate(usuarios, 1): 
                print(f"{i}. {usuario.nombre} (Saldo: ${usuario.get_saldo():.2f})")
        ...
        elif opcion == "6": #Opción 6: Agregar saldo a la cuenta de un usuario
            print("\n--- AGREGAR SALDO ---")
            for i, usuario in enumerate(usuarios, 1):
        ...
        elif opcion == "7": #Opción 7: Salir del programa        
